...
void VoronoiDiagramGenerator::pushGraphEdge(float x1, float y1, float x2, float y2, Site* sites[])
{
...
void VoronoiDiagramGenerator::line(float x1, float y1, float x2, float y2, Site* sites[])
{	
